#!/usr/bin/env python3
"""Velocity Simulation Pipeline.

Starts Gazebo with the Franka FR3 and spawns fr3_velocity_controller.
External nodes publish joint velocity commands to:
  /fr3_velocity_controller/commands  (Float64MultiArray, 7 joints)

No MoveIt, no CBF — minimal clean velocity pipeline for external commanders.
"""
...
def generate_launch_description():
    ...
    #   velocity_circle_trajectory   — sinusoidal multi-joint motion
    #   velocity_figure8_trajectory  — Lissajous / figure-8 pattern
    trajectory_node = Node(
        package='franka_simulation',
        executable='cartesian_velocity_mapper',
        output='screen',
    )
    # ---------------------------------------------------------------------
