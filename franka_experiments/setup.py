...
setup(
    ...
    entry_points={
        'console_scripts': [
            ...
            'trajectory_visualization_node = franka_experiments.nodes.trajectory_visualization_node:main',
            'trajectory_overlay_node = franka_experiments.nodes.trajectory_overlay_node:main',
            'handeye_calibration_node = franka_experiments.nodes.handeye_calibration_node:main',
            'handeye_eye_in_hand_node = franka_experiments.nodes.handeye_eye_in_hand_node:main',
            'image_rectifier_node = franka_experiments.nodes.image_rectifier_node:main',
            'tag_overlay_node = franka_experiments.nodes.tag_overlay_node:main',
