    ...
    def __init__(self):
        ...
        if MultiDistance is not None:
            ...
            self.get_logger().warn(
                "franka_msgs/MultiDistance is not available in this workspace: "
                "CBF distance plots will be skipped, but joint-state logging still works."
            )
        self.create_subscription(
            Float64MultiArray,
