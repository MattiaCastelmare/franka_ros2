...
CBF_PARAM_SPEC = {
    ...
    'cbf_tangential_gain': ('float', dict(minimum=0.0, maximum=10.0)),
    'cbf_tangential_engage_margin': ('float', dict(positive=True, maximum=1.0)),
    'cbf_tangential_filter_alpha': ('float', dict(minimum=0.0, maximum=0.98)),
    'cbf_tangential_max_bias': ('float', dict(positive=True, maximum=100.0)),
    ...
    'self_collision_max_rows': ('int', dict(minimum=1, maximum=32)),
    'self_collision_row_lead_s': ('float', dict(minimum=0.0, maximum=2.0)),
    'self_collision_row_release': ('float', dict(minimum=1.0, maximum=5.0)),
    'self_collision_gap_vel_alpha': ('float', dict(minimum=0.0, maximum=0.95)),
    ...
    'velocity_standoff_time_s': ('float', dict(minimum=0.0, maximum=2.0)),
    'velocity_standoff_max': ('float', dict(positive=True, maximum=1.0)),
